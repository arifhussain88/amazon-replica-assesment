...
export function BuyBox({
  ...
  return (
    <aside
      id="buy-box"
      className="z-30 h-fit rounded-md border border-border bg-card p-4 max-lg:fixed max-lg:inset-x-0 max-lg:bottom-0 max-lg:max-h-[45vh] max-lg:overflow-y-auto max-lg:rounded-none max-lg:border-x-0 max-lg:border-b-0 lg:sticky lg:top-4 lg:row-span-3 lg:self-start"
    >
      <AddToCartForm
        productId={productId}
      ...
      {flight ? (
        <motion.img
          ...
          aria-hidden
          data-cart-flight=""
          className="pointer-events-none fixed z-50 size-12 rounded-md border border-border bg-card object-contain"
